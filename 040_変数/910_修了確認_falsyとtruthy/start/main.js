...
// console.log('"false" == false', "false" == false); // 文字列はfalse
// console.log('"0" == 0', "0" == 0); // '0 == 0', true 暗黙的な型変換が行われる。
// console.log('Boolean("0") === false', Boolean("0") === false);
// // //('Boolean("0") === false' true Boolean("0")はfalseとなる
// console.log('Boolean(0) === false', Boolean(0) === false);
// // Boolean(0) === false , true 0はfalse
// console.log('!Boolean(0) === false', !Boolean(0) === false);
// // !Boolean(0) === false, false
// console.log('-1 == false', -1 == false);
// // -1 == false, false
// console.log('!10 === false', !10 === false);
// // !10 === false, true !10はbooleanの変換が行われる。
